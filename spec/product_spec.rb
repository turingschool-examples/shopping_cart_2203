...
describe Product do
  context 'Iteration 1' do
    ...
    it "checks hoarding" do
      product1 = Product.new(:paper, 'toilet paper', 3.70, '10')
      product2 = Product.new(:meat, 'chicken', 4.50, '2')

      expect(product1.is_hoarded?).to be true
      expect(product2.is_hoarded?).to be false
    end

    it "can hoard products" do
      product = Product.new(:meat, 'chicken', 4.50, '2')
